...
img1 = cv2.imread('C:\\Users\\victo\\Google Drive\\Profissional - academico\\Programas\\phyton\\3d.png')
img2 = cv2.imread('C:\\Users\\victo\\Google Drive\\Profissional - academico\\Programas\\phyton\\svm.png')
img = cv2.imread('C:\\Users\\victo      \\Google Drive\\Profissional - academico\\Programas\\phyton\\mainlogo.png')

#soma a imagem, B,G,R vai ate 255 e volta pro 0 e continua.. nao é o melhor jeito.
#add = img1 + img2
